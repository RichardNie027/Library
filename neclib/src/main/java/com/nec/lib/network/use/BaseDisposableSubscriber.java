...
import com.nec.lib.network.net.dialog.CustomProgressDialogUtils;
import com.nec.lib.network.net.revert.BaseResponseEntity;
import com.nec.lib.network.utils.ApiConfig;
import com.nec.lib.network.utils.AppContextUtils;
import com.nec.lib.network.utils.VariableUtils;
...
/**
 * Flowable 通过subscribeWith接收并返回Disposable对象，经过CompositeDisposable管理Disposable对象，如果项目中不使用RxLifecycle管理网络请求，而想自己管理网络请求，则使用该方法，接收返回的网络请求
 *
